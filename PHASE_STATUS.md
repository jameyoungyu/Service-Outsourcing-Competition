...
- 前端 14 个业务视图全部改为真实数据绑定，删除全部 mock 回退（清洗、优选、时滞、共线性、辨识、寻优、Agent、交付、基准）。
...
- **阶段 4–11 全量后端测试：`237 passed`**（含清洗路由、门控与优选、时滞与共线性、辨识与先验、闭环寻优与策略记忆、Agent 与合规证明、报告溯源与导出、自评测基准、加权分对照基线）；
